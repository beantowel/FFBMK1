...
0x81,0x02,                //        Input(IOF_Variable),
0xc0,                     //    End_Collection(),
0x09,0x21,                //    Usage(PID_Set_Effect_Report),
0xa1,0x02,                //    Collection(Clc_Logical),
0x85,0x01,                //        Report_ID(1),
0x09,0x22,                //        Usage(PID_Effect_Block_Index),
0x15,0x01,                //        Logical_Minimum(1),
...
0x09,0x30,                //            Usage(PID_ET_Square),
0x09,0x31,                //            Usage(PID_ET_Sine),
0x09,0x32,                //            Usage(PID_ET_Triangle),
0x09,0x33,                //            Usage(PID_ET_Sawtooth_Up),
0x09,0x34,                //            Usage(PID_ET_Sawtooth_Down),
0x09,0x40,                //            Usage(PID_ET_Spring),
0x09,0x41,                //            Usage(PID_ET_Damper),
0x09,0x42,                //            Usage(PID_ET_Inertia),
0x09,0x43,                //            Usage(PID_ET_Friction),
0x09,0x28,                //            Usage(PID_ET_Custom_Force_Data),
...
0xa1,0x02,                //        Collection(Clc_Logical),
0x0b,0x01,0x00,0x0a,0x00, //            Usage(Instance_1:Ordinal_ID),
0x0b,0x02,0x00,0x0a,0x00, //            Usage(Instance_2:Ordinal_ID),
...
0xc0,                     //    End_Collection(),
0x05,0x0f,                //    Usage_Page(Physical_Interface),
0x09,0x5a,                //    Usage(PID_Set_Envelope_Report),
0xa1,0x02,                //    Collection(Clc_Logical),
0x85,0x02,                //        Report_ID(2),
0x09,0x22,                //        Usage(PID_Effect_Block_Index),
0x15,0x01,                //        Logical_Minimum(1),
...
0x55,0x00,                //        Unit_Exponent(0),
0xc0,                     //    End_Collection(),
0x09,0x5f,                //    Usage(PID_Set_Condition_Report),
0xa1,0x02,                //    Collection(Clc_Logical),
...
0x95,0x01,                //        Report_Count(1),
0x91,0x02,                //        Output(IOF_Variable),
0x09,0x58,                //        Usage(PID_Type_Specific_Block_Offset),
0xa1,0x02,                //        Collection(Clc_Logical),
0x0b,0x01,0x00,0x0a,0x00, //            Usage(Instance_1:Ordinal_ID),
0x0b,0x02,0x00,0x0a,0x00, //            Usage(Instance_2:Ordinal_ID),
...
0x95,0x01,                //        Report_Count(1),
0xc0,                     //    End_Collection(),
0x09,0x6e,                //    Usage(PID_Set_Periodic_Report),
0xa1,0x02,                //    Collection(Clc_Logical),
...
0x91,0x02,                //        Output(IOF_Variable),
0xc0,                     //    End_Collection(),
0x09,0x68,                //    Usage(PID_Custom_Force_Data_Report),
0xa1,0x02,                //    Collection(Clc_Logical),
...
0x95,0x01,                //        Report_Count(1),
0x91,0x02,                //        Output(IOF_Variable),
0x09,0x6c,                //        Usage(PID_Custom_Force_Data_Offset),
0x15,0x00,                //        Logical_Minimum(0),
...
0x95,0x01,                //        Report_Count(1),
0x91,0x02,                //        Output(IOF_Variable),
0x09,0x69,                //        Usage(PID_Custom_Force_Data),
...
0x92,0x02,0x01,           //        Output(IOF_VariableBuffer),
0xc0,                     //    End_Collection(),
0x09,0x66,                //    Usage(PID_Download_Force_Sample),
0xa1,0x02,                //    Collection(Clc_Logical),
...
0x91,0x02,                //        Output(IOF_Variable),
0xc0,                     //    End_Collection(),
0x09,0x6b,                //    Usage(PID_Set_Custom_Force_Report),
0xa1,0x02,                //    Collection(Clc_Logical),
...
0x95,0x01,                //        Report_Count(1),
0x91,0x02,                //        Output(IOF_Variable),
0x09,0x6d,                //        Usage(PID_Sample_Count),
0x15,0x00,                //        Logical_Minimum(0),
0x26,0xff,0x00,           //        Logical_Maximum(255),
0x35,0x00,                //        Physical_Minimum(0),
0x46,0xff,0x00,           //        Physical_Maximum(255),
...
0xb1,0x02,                //        Feature(IOF_Variable),
0xc0,                     //    End_Collection(),
0x09,0x7f,                //    Usage(PID_PID_Pool_Report),
0xa1,0x02,                //    Collection(Clc_Logical),
0x85,0x07,                //        Report_ID(7),
0x09,0x80,                //        Usage(PID_RAM_Pool_Size),
0x75,0x10,                //        Report_Size(16),
0x95,0x01,                //        Report_Count(1),
0x15,0x00,                //        Logical_Minimum(0),
0x35,0x00,                //        Physical_Minimum(0),
...
0x47,0xff,0xff,0x00,0x00, //        Physical_Maximum(65535),
0xb1,0x02,                //        Feature(IOF_Variable),
0x09,0x83,                //        Usage(PID_Simultaneous_Effects_Max),
0x26,0xff,0x00,           //        Logical_Maximum(255),
0x46,0xff,0x00,           //        Physical_Maximum(255),
0x75,0x08,                //        Report_Size(8),
0x95,0x01,                //        Report_Count(1),
0xb1,0x02,                //        Feature(IOF_Variable),
0x09,0xa9,                //        Usage(PID_Device_Managed_Pool),
0x09,0xaa,                //        Usage(PID_Shared_Parameter_Blocks),
0x75,0x01,                //        Report_Size(1),
0x95,0x02,                //        Report_Count(2),
0x15,0x00,                //        Logical_Minimum(0),
0x25,0x01,                //        Logical_Maximum(1),
...
0x95,0x01,                //        Report_Count(1),
0xb1,0x03,                //        Feature(IOF_ConstVar),
0xc0,                     //    End_Collection(),
0xc0,                     //End_Collection(),
//Total:1239 Bytes
};
...
//	USBD_PID_DataIn(pdev, epnum); //beantowel
  ((USBD_HID_HandleTypeDef *)pdev->pClassData)->state = HID_IDLE;
  return USBD_OK;
}
                              ...
                              uint8_t epnum)
{
  ...
  be caused by  a new transfer before the end of the previous transfer */
	((USBD_HID_HandleTypeDef *)pdev->pClassData)->state = HID_IDLE;
	USBD_PID_DataOut(pdev, epnum); //beantowel
  return USBD_OK;
}
